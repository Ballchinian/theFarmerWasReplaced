...
#previousDirectionTracker = 4
coordinates[get_pos_x(), get_pos_y()] = [True,True,True,True,0]
	...
	for directionValidator in coordinates[get_pos_x(), get_pos_y()]:
		...
		if directionValidator == True:
			...
			if move(directions[directionTracker]) == True:
				...
				if coordinates[previousXCoordinate, previousYCoordinate][4] == 3:
				...
				#Tracks Number of dead paths into coordinates
				coordinates[get_pos_x(), get_pos_y()][directionTracker] = False
				coordinates[get_pos_x(), get_pos_y()][4] = coordinates[get_pos_x(), get_pos_y()][4] + 1
